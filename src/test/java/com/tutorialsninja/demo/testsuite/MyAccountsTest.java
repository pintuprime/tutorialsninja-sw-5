...
public class MyAccountsTest extends BaseTest {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() throws InterruptedException {
        ...
        registerPage.sendFirstName("YouR");
        //3.4 Enter Last Name
        ...
        //3.7 Enter Password
        registerPage.sendPassword("mnbvcxz09");
        //3.8 Enter Password Confirm
        registerPage.sendConfirmPassword("mnbvcxz09");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
        ...
        homePage.selectMyAccountOptions("Login");
        //4.3 enter email
        loginPage.sendEmail("hhh@gmail.com");
        //enter password
        loginPage.sendPassword("mnbvcxz09");
        //click login
