...
public class LaptopAndNotebooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        checkoutPage.enterBillingDetailsFirstName("Tom");
        ...
        Thread.sleep(500);
        checkoutPage.enterBillingDetailsTelephone("0761234578");
        checkoutPage.enterBillingDetailsAddress("10 Downing Road");
        checkoutPage.enterBillingDetailsCity("Harrow");
        checkoutPage.enterBillingDetailsPostcode("HA33SY");
